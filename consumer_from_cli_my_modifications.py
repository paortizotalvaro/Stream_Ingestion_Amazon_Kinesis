...
def poll_shards(kinesis, shard_iterators):
    ...
    while True:
        ...
        # Waits for 1 second before polling the shards again 
        # to avoid overwhelming the Kinesis API.
        time.sleep(1)
...
def main():
    ...
    # parse stream name with argparse
    args = parser.parse_args()
    kinesis_stream_name = args.stream

    # create a Kinesis client using the AWS SDK for Python, Boto3.
